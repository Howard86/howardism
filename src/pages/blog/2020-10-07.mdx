...
Since starting programming 6 years ago, especially from a mathematical background, I have been wondering the reason why we write codes, or how we should think about writing codes. Does not quite make sense, right? We **solved** problems, buy why should we?
...
I am a big fan of [Sudoku](https://en.wikipedia.org/wiki/Sudoku). People like me enjoy the process of working on problems, even someone else might have invented a solution that is 100 times more brilliant and efficient than mine. Why are spending time wrapping our heads around, and trying to figure out something that obviously has a solution?

I guess we just love solving problems, no matter how trivial or unimportant they are.
